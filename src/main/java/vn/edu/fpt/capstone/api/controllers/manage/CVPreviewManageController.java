...
@RequestMapping(CVPreviewManageController.PATH)
@SecurityRequirement(name = "BearerAuth")
@Tag(name = "CV preview", description = "preview CV")
public class CVPreviewManageController {
    public static final String PATH = AppConfig.MANAGE_PATH + AppConfig.V1_PATH + "/cv-preview";
